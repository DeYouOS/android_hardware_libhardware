...
#ifndef HAL_IMAGE_PROCESSOR_H_
#define HAL_IMAGE_PROCESSOR_H_
...
struct ImageProcessor : virtual public android::RefBase {
    ...
    // Convert format from |in_frame.fourcc| to |out_frame->fourcc|. Caller
    // should fill |data|, |buffer_size|, |width|, and |height| of |out_frame|.
    // The function will fill |out_frame->data_size|. Return non-zero error code
